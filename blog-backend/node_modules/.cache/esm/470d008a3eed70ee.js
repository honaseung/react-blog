let Koa,Router,postApi,bodyParser,mongoose,authApi,jwtMiddleware;_3ee‍.w("koa",[["default",["Koa"],function(v){Koa=v}]]);_3ee‍.w("koa-router",[["default",["Router"],function(v){Router=v}]]);_3ee‍.w("./api/posts",[["default",["postApi"],function(v){postApi=v}]]);_3ee‍.w("koa-bodyparser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_3ee‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_3ee‍.w("./api/auth",[["default",["authApi"],function(v){authApi=v}]]);_3ee‍.w("./lib/jwtMiddleware",[["default",["jwtMiddleware"],function(v){jwtMiddleware=v}]]);require('dotenv').config();
...
mongoose
  ...
  .catch((e) => _3ee‍.g.console.log('Fail to connect', e));
