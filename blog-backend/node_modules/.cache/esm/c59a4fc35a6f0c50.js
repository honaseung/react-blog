let Post,mongoose,Joi,array,string;_5a6‍.x([["checkObjectId",()=>checkObjectId],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_5a6‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_5a6‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_5a6‍.w("joi",[["default",["Joi"],function(v){Joi=v}],["array",["array"],function(v){array=v}],["string",["string"],function(v){string=v}]]);
