let Koa,Router,postApi,bodyParser,mongoose,authApi;_58e‍.w("koa",[["default",["Koa"],function(v){Koa=v}]]);_58e‍.w("koa-router",[["default",["Router"],function(v){Router=v}]]);_58e‍.w("./api/posts",[["default",["postApi"],function(v){postApi=v}]]);_58e‍.w("koa-bodyparser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_58e‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_58e‍.w("./api/auth",[["default",["authApi"],function(v){authApi=v}]]);require('dotenv').config();
...
mongoose
  ...
  .catch((e) => _58e‍.g.console.log('Fail to connect', e));
